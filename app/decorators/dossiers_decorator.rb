...
class DossiersDecorator < Draper::CollectionDecorator
  COLUMNS_FOR_CSV = [:code, :date_appel, :motif_code, :age, :poids, :taille, :atcds_fam, :atcds_perso, :grsant, :fcs, :geu, :miu, :ivg, :img, :nai, :tabac, :alcool, :age_grossesse, :evolution, :terme, :modaccouch, :nbr_bebes, :bb1_sexe, :bb1_poids, :bb1_taille, :bb1_pc, :bb1_apgar1, :bb1_apgar5, :malformation, :pathologie, :expo_terato]
