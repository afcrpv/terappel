...
ActiveRecord::Schema.define(version: 20_150_611_080_726) do
  ...
  add_index 'active_admin_comments', %w(resource_type resource_id), name: 'index_admin_notes_on_resource_type_and_resource_id', using: :btree
