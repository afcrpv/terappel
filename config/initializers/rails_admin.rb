...
RailsAdmin.config do |config|
  ...
  # config.excluded_models << [Centre, Dossier, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models << [Centre, Dossier, User]
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model Centre do
  #   # Found associations:
  #   field :users, :has_many_association
  #   field :dossiers, :has_many_association
  #   # Found columns:
  #   field :id, :integer
  #   field :name, :string
  #   field :code, :string
...
# Fields may also be marked as read_only (and thus not editable) if they are not mass-assignable by current_user
  ...
  # config.model Dossier do
  #   # Found associations:
  #   field :centre, :belongs_to_association
  #   field :user, :belongs_to_association
  #   # Found columns:
  #   field :id, :integer
  #   field :date_appel, :date
  #   field :name, :string
  #   field :user_id, :integer        # Hidden
  #   field :created_at, :datetime
  #   field :updated_at, :datetime
  #   field :centre_id, :integer        # Hidden
  #   field :code, :string
  #   # Sections:
  #   list do; end
  #   export do; end
