...
When /^they enter a new password$/ do
  fill_in I18n.t('devise.passwords.new_password').to_s, with: 'newpass'
  fill_in I18n.t('devise.passwords.confirm_new_password').to_s, with: 'newpass'
  click_button I18n.t('devise.passwords.change_my_password').to_s
end
